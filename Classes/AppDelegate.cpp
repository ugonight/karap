...
static cocos2d::Size mediumResolutionSize = cocos2d::Size(480, 854);
static cocos2d::Size largeResolutionSize = cocos2d::Size(480, 854);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("karap", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("karap");
#endif
	...
	searchPath.push_back("karap");
	searchPath.push_back("task");
